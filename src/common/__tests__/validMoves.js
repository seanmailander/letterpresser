...
export default function validMoves() {
  describe('generateValidMoves', function () {
    it('finds all valid moves for simple board', function () {
      const board = 'bananas';
      const word = 'ban';
      const expectedMoves = ['1,0,2', '3,0,2', '5,0,2', '1,0,4', '3,0,4', '5,0,4'];
      const foundMoves = getValidMovesFromWord(board, word);

      const mismatchedMoves = symmetricDifference(new Set(expectedMoves), new Set(foundMoves));
    ...
    it('finds all valid moves for complex board', function () {
      ...
      const mismatchedMoves = symmetricDifference(expectedMovesSet, new Set(foundMoves));
